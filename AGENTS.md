...
- 每轮开发收尾必须核对文档：除更新 memory / todo / summary 外，核对 README 中涉及本轮的章节（版本号 / 功能 / 测试数等），并在输出中声明"已核对 README，无过时内容"；文档整理必须全量核对 README / memory / todo / summary / AGENTS 与 overview.md，不得只改部分文件。
